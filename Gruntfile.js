// Generated on 2014-04-12 using generator-webapp-rjs 0.4.8
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            jst: {
                files: [
                    '<%= yeoman.app %>/scripts/apps/*/*/templates/*.ejs'
                ],
                tasks: ['jst']
            }
        },
        ...
        jst: {
            ...
            compile: {
                files: {
                    '.tmp/scripts/templates.js': ['<%= yeoman.app %>/scripts/apps/*/*/templates/*.ejs']
                }
            }
        },
